#+title: ELAIZA
#+LAST_MODIFIED: [2024-04-29 Mon 18:26]
...
This package provides a llm-agnostic backend with a chat interface. To honor its [[https://en.wikipedia.org/wiki/ELIZA][ancestor]], you can also talk to a new AI-enhanced Emacs doctor via =M-x elaiza-doctor=.
